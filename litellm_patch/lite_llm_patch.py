...
def _function_declaration_to_tool_param(
    ...
    if (
        ...
        if (
            ...
            required_list = function_declaration.parameters.required

        if (function_declaration.parameters and function_declaration.parameters.type):
            t = function_declaration.parameters.type
            type_string = (t.value if isinstance(t, types.Type) else t).lower()
